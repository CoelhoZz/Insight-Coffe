    ...
    public partial class APSvendas : Form
    {
        ...
        private void listadepesquisa()
        {
            foreach (Produto produto in inicial1.produtos)
            {
                ...
                comboBoxCodProd.Items.Add(produto.Descricao);
                produto
            }
        }
        ...
        private void txtChanged_ComBox(object sender, EventArgs e)
        {
            foreach (Produto produto in inicial1.produtos)
            {
                if (produto.Descricao.Contains(comboBoxCodProd.Text))
                    comboBoxCodProd.Items.Add(produto.Descricao);
            }
        }
        ...
        {
            string sPattern = comboBoxCodProd.Text;
            comboBoxCodProd.Items.Add(inicial1.produtos.Find(x => x.Descricao.Contains(sPattern)));
        }
        //
